...
import com.grupo20.ttpsspringboot.services.interfaces.IPublicacionService;
...
public class PublicController extends BaseController {
    ...
    public ResponseEntity<PaginateBaseDTO<PublicacionDTO>> getPublicaciones(@ParameterObject @ModelAttribute PublicacionFilterDTO filter) {
